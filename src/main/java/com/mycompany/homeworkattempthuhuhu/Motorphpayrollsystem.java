...
public double  netSalary(int employeeId) throws IllegalArgumentException {
    Employee employee = getEmployeeById(employeeId);
                ...
                choice = scanner.nextInt();
                 switch (choice) {
                    ...
                    case 4:
                        ...
                        philHealth = scanner.nextLine();
                        System.out.println("Enter TIN Number: ");
                        tinNum = scanner.nextLine();
                        System.out.println("Enter PAG-IBIG Number: ");
                        pagIbig = scanner.nextLine();
                        employeeManager.addEmployee(id, firstName, lastName, birthday, position, hourlyRate, salary, sss, philHealth, tinNum, pagIbig);
                        break;
