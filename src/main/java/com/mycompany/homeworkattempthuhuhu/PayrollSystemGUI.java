...
public class PayrollSystemGUI extends JFrame {
    ...
    JPanel menuPanel; // Declare menuPanel at the class level
        ...
        //new EmployeeTable(payrollSystem);
     ...
     // Menu panel with GridLayout for buttons
        ...
        buttonView = new JButton("View ALL Employees");
     ...
     buttonOvertime.addActionListener(e -> {
        ...
        buttonAddEmployee.addActionListener(e -> {
            ...
            JTextField tinNumField = new JTextField(10);
            ...
            if (result == JOptionPane.OK_OPTION) {
                try {
                    ...
                    String tinNum = tinNumField.getText();
                    String pagIbig = pagIbigField.getText();
                    manageEmployee.addEmployee(id, firstName, lastName, birthday, position, hourlyRate, salary, sss, philHealth, tinNum, pagIbig);
             ...
             buttonView.addActionListener(new ActionListener() {
                ...
                new EmployeeTable(payrollSystem, manageEmployee); // Pass both
                 }
        });
